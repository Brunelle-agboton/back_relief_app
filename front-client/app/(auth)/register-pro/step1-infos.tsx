...
type RootStackParamList = {
  '/register-pro/step2-credentials': { userName: string; email: string; password: string };
};
...
export default function RegisterStep1Screen() {
  ...
  const handleNext = () => {
    ...
    setError('');
     router.push({
         pathname: '/register-pro/step2-credentials', // Le chemin correct
          params: { userName, email, password } // Les données à passer
      });
  };
...
Information demandées aux professionels    </Text>
