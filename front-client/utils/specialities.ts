export const specialites = [
  { id: 1, name: 'Orthopédique' },
  { id: 2, name: 'Neurologique' },
  { id: 3, name: 'Vasculaire' },
  { id: 4, name: 'Urologique' },
  { id: 5, name: 'Respiratoire' },
  { id: 6, name: 'Pédiatrique' },
  { id: 7, name: 'Gériatrique' },
  { id: 8, name: 'Sportive' },
  { id: 9, name: 'Rhumatologique' },
  { id: 10, name: 'Douleur' },
  { id: 11, name: 'Post-chirurgicale' },
  { id: 12, name: 'Esthétique' },
  { id: 13, name: 'Santé publique et prévention' },
  { id: 14, name: 'Ergothérapeute' },
];
